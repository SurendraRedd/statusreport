...
start_date3 = st.date_input(":calendar: Execution Start Date", datetime.date(2024, 5, 22))
st.write("\n")
...
with tab1:
    ...
    if home_switch_value1 and home_switch_value2 and home_switch_value3:
        ...
        end_date3 = st.date_input(":calendar: Execution Completed Date", datetime.date(2024, 5, 23))
