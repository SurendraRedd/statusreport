...
with tab4:
    ...
    with col1:
        ...
        with st.expander("Activities", expanded=True):
            ...
            home_switch_value7 = st.checkbox(":memo: Installation (Yes/No)", value=st.session_state.home_switches["homeswitch5"], key="homeswitch5")
    ...
    with col2:
        ...
        with st.expander("Activities", expanded=True):
            ...
            home_switch_value8 = st.checkbox(":memo: Uninstallation (Yes/No)", value=st.session_state.home_switches["homeswitch6"], key="homeswitch6")
