...
with tab1:
    ...
    with col1:
        ...
        with st.expander("Activities", expanded=True):
            to_do([(st.write, ":memo: Initial SEQ Signature Completed?")], "1")
            to_do([(st.write, ":memo: Installation Plan & Report Signature Completed?")], "2")
            to_do([(st.write, ":memo: Installation SEQ Signature Completed?")], "3")
            to_do([(st.write, ":memo: Servat Execution Completed?")], "4")
            st.write("---")
    ...
    with col2:
        ...
        with st.expander("Activities", expanded=True):
            to_do([(st.write, ":memo: Installation with PVC SEQ Signature Completed?")], "5")
            to_do([(st.write, ":memo: Uninstallation Plan & Report Signature Completed?")], "6")
            to_do([(st.write, ":memo: Uninstallation SEQ Signature Completed?")], "7")
...
with tab2:
    ...
    with col1:
        st.subheader(":hammer_and_wrench: Installation")
        with st.expander("Activities", expanded=True):
            to_do([(st.write, ":memo: Initial SEQ Signature Completed?")], "9")
            to_do([(st.write, ":memo: Installation Plan & Report Signature Completed?")], "10")
            to_do([(st.write, ":memo: Installation SEQ Signature Completed?")], "11")
...
with tab3:
    ...
    with col2:
        st.subheader(":wastebasket: Uninstallation")
        with st.expander("Activities", expanded=True):
            to_do([(st.write, ":memo: Installation with PVC SEQ Signature Completed?")], "21")
            to_do([(st.write, ":memo: Uninstallation Plan & Report Signature Completed?")], "22")
            to_do([(st.write, ":memo: Uninstallation SEQ Signature Completed?")], "23")
...
with tab4:
    ...
    with col1:
        st.subheader(":hammer_and_wrench: Installation")
        with st.expander("Activities", expanded=True):
            to_do([(st.write, ":memo: Initial SEQ Signature Completed?")], "25")
            to_do([(st.write, ":memo: Installation Plan & Report Signature Completed?")], "26")
            to_do([(st.write, ":memo: Installation SEQ Signature Completed?")], "27")
    ...
    with col2:
        st.subheader(":wastebasket: Uninstallation")
        with st.expander("Activities", expanded=True):
            to_do([(st.write, ":memo: Installation with PVC SEQ Signature Completed?")], "29")
            to_do([(st.write, ":memo: Uninstallation Plan & Report Signature Completed?")], "30")
            to_do([(st.write, ":memo: Uninstallation SEQ Signature Completed?")], "31")
